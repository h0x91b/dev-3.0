...
| **Graceful exit before teardown** (`exitProgram`) | Ctrl-C, `/exit`, Enter — SessionEnd hooks run | Ctrl-C, `/exit`, Enter | Ctrl-C, `/quit`, Enter | Ctrl-C, `/quit`, Enter | Ctrl-C, `/exit`, Enter | Ctrl-C, `/exit`, Enter | Ctrl-C, `/exit`, Enter |
