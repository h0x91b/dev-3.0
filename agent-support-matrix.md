...
| **Graceful exit before teardown** (`exitProgram`) | Ctrl-C, `/exit`, Enter — verified against 2.1.273; SessionEnd hooks run | Ctrl-C, `/exit`, Enter (unverified) | Ctrl-C, `/quit`, Enter (unverified) | Ctrl-C, `/quit`, Enter — verified against gemini-cli 0.46.0 | Ctrl-C, `/exit`, Enter (unverified) | Ctrl-C, `/exit`, Enter (unverified) | Ctrl-C, `/exit`, Enter (unverified) |
