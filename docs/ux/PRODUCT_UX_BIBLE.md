...
| Sidebar | Active-task jump list | destination, task jump, terminal preview, search + token-DSL task filter (funnel, active-statuses pool) | durable config | `ActiveTasksSidebar.tsx`, `FilterFunnel.tsx` |
