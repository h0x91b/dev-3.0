...
- \`dev3 notify "message" [--level info|success|error] [--duration <seconds>]\` — clickable in-app toast (ephemeral; duration is 2s–30s, e.g. \`--duration 2s\`); \`--desktop\` sends a native OS notification that shows even when the app is backgrounded.
