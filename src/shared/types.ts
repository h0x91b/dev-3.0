...
export const DEFAULT_AGENTS: CodingAgent[] = [
	{
		...
		configurations: [
			{ id: "claude-default", name: "Default (By Default)", additionalArgs: ["--dangerously-skip-permissions"], version: 3 },
			{ id: "claude-default-sonnet", name: "Default (Sonnet)", model: "sonnet[1m]", additionalArgs: ["--dangerously-skip-permissions"] },
			{ id: "claude-plan", name: "Plan (By Default)", permissionMode: "plan", additionalArgs: ["--dangerously-skip-permissions"], version: 3 },
			{ id: "claude-plan-sonnet", name: "Plan (Sonnet)", model: "sonnet[1m]", permissionMode: "plan", additionalArgs: ["--dangerously-skip-permissions"] },
			{ id: "claude-bypass", name: "Bypass (By Default)", permissionMode: "bypassPermissions", additionalArgs: ["--dangerously-skip-permissions"], version: 3 },
			...
			{ id: "claude-auto", name: "Auto (By Default)", permissionMode: "auto", version: 3 },
			{ id: "claude-auto-sonnet", name: "Auto (Sonnet)", model: "sonnet[1m]", permissionMode: "auto" },
			{ id: "claude-approvals", name: "Accept Edits (By Default)", permissionMode: "acceptEdits", additionalArgs: ["--dangerously-skip-permissions"], version: 3 },
			...
			{ id: "claude-dontask", name: "Don't Ask (By Default)", permissionMode: "dontAsk", additionalArgs: ["--dangerously-skip-permissions"], version: 3 },
