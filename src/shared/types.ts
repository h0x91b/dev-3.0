		...
		configurations: [
			{
				...
				model: "gpt-5.4",
				additionalArgs: ["--search", "--full-auto", "--no-alt-screen", "--sandbox", "never", "-c", 'model_reasoning_effort="medium"'],
			},
			{
				id: "codex-plan",
				name: "Plan (GPT-5.4)",
				...
				additionalArgs: ["--search", "--no-alt-screen", "--sandbox", "never", "-c", 'model_reasoning_effort="high"'],
			},
			{
				id: "codex-heavy",
				name: "Heavy (GPT-5.4 High)",
				model: "gpt-5.4",
				additionalArgs: ["--search", "--full-auto", "--no-alt-screen", "--sandbox", "never", "-c", 'model_reasoning_effort="high"'],
			},
			{
