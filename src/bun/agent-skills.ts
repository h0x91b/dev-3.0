...
- \`dev3 show-artifact <file.html> [--images <image...>] [--title "..."]\` — **show the user an interactive HTML artifact** in a sandboxed task workspace. Keep the HTML self-contained except for relative raster assets explicitly listed after \`--images\`; those files are copied beside it. Artifacts with images download as a ZIP, while standalone artifacts download as HTML.
