...
- \`dev3 show-artifact <file.html> [--images <image...>] [--title "..."]\` — **show the user an interactive HTML artifact** in a sandboxed task workspace. The HTML must be self-contained; paths after \`--images\` are copied beside it for relative references. Artifacts with images download as a ZIP, while standalone artifacts download as HTML.
