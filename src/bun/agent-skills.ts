...
- **Work from your phone / remotely → dev3 remote.** The full app is served to a browser through a secure tunnel; open it anywhere. Mobile has its own pane pager and message composer, and browser notifications keep the agent's pings reaching you. To copy exact text out of a terminal on a phone, press and hold on it and then drag — the hold anchors a selection, releasing copies it to the device clipboard.
