 ...
 *
 * Claude only. Codex reads its dev3 hooks from its user config fixed at launch,
 * and omp loads its status extension once at launch, so rewriting either file
 * mid-session would change nothing.
 */
