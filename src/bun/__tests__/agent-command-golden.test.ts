...
const EXPECTED: Record<string, string> = {
	"claude/fresh": "claude --model sonnet --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/fresh-empty": "claude --model sonnet --append-system-prompt <CLAUDE_BODY>",
	"claude/resume-nosid": "claude --continue --model sonnet --append-system-prompt <CLAUDE_BODY>",
	"claude/resume-sid": "claude --resume 11111111-1111-1111-1111-111111111111 --model sonnet --append-system-prompt <CLAUDE_BODY>",
	"claude/preassign-sid": "claude --session-id 11111111-1111-1111-1111-111111111111 --model sonnet --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/skipSysPrompt": "claude --model sonnet -- 'Fix the login bug'",
	"claude/statusline": "claude --model sonnet --append-system-prompt <CLAUDE_BODY> --settings /tmp/s.json -- 'Fix the login bug'",
	"claude/pm-plan": "claude --model sonnet --permission-mode plan --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/pm-acceptEdits": "claude --model sonnet --permission-mode acceptEdits --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/pm-bypassPermissions": "claude --model sonnet --permission-mode bypassPermissions --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/pm-dontAsk": "claude --model sonnet --permission-mode dontAsk --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/effort": "claude --model sonnet --effort high --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/budget": "claude --model sonnet --max-budget-usd 12 --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/addargs": "claude --model sonnet --append-system-prompt <CLAUDE_BODY> --foo bar -- 'Fix the login bug'",
	"claude/appendPrompt": "claude --model sonnet --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug\n\nExtra: Fix bug'",
	...
	"claude/provider-bedrock": "claude --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
	"claude/model-1m": "claude --model 'claude-opus-4-8[1m]' --append-system-prompt <CLAUDE_BODY> -- 'Fix the login bug'",
