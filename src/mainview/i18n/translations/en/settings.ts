const settings = {
	...
	"projectSettings.tabWorktreeDesc": "Per-worktree overrides — committed to git or local-only",
	"projectSettings.appConfigWarning": "Stored locally on this machine. Not shared with team.",
	"projectSettings.worktreeSelector": "Select a task to edit its worktree config",
	"projectSettings.noActiveWorktrees": "No active worktrees — start a task first",
