const settings = {
	...
	"settings.accountsActive": "Active",
	...
	"settings.accountsNewSessionsHint": "Switching accounts affects newly launched agent sessions only — running sessions keep their current login.",
