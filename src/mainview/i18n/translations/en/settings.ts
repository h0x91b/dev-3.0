const settings = {
	...
	"settings.tunnelDesc": "Route remote access through a public Cloudflare Tunnel URL instead of local network IP. Requires cloudflared to be installed.",
	"settings.tunnelHint": "Install: brew install cloudflared. When enabled, the QR code uses a public https URL accessible from anywhere. Requires app restart.",
