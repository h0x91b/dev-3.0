const settings = {
	...
	"projectSettings.tabProjectDesc": "Project-level settings — stored locally on this machine, not shared with team",
	"projectSettings.tabWorktreeDesc": "Per-worktree overrides — these take priority over Project Config when set",
	...
	"projectSettings.worktreeRepoDesc": "Committed to git as .dev3/config.json — shared with your team. Overrides Project Config for this worktree.",
	"projectSettings.worktreeLocalDesc": "Machine-specific overrides — git-ignored as .dev3/config.local.json. Highest priority, never shared.",
	"projectSettings.worktreePriorityHint": "Worktree config takes priority over Project Config. If a field is set here, the Project Config value is ignored for this task.",
