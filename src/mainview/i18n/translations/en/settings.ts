const settings = {
	...
	"settings.diffToolDesc": "Tool used for viewing diffs in tasks",
	"settings.diffToolNotFound": "not found",
	"settings.diffToolCustomHint": "Use $LOCAL for the base version and $REMOTE for the changed version. Example: my-diff-tool --left $LOCAL --right $REMOTE",
