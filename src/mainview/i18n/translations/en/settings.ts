const settings = {
	...
	"settings.preventSleepDesc": "Keep your Mac awake while agents are running (uses caffeinate)",
	"settings.preventSleepNotAvailable": "caffeinate not found on PATH. It ships with macOS by default — check your system.",
