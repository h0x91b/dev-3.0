const settings = {
	...
	"settings.updateChannelDesc": "Stable ships only tagged releases. Unstable is built from every batch of merges to main — it is not a tested release.",
	"settings.updateChannelStable": "Stable",
	"settings.updateChannelUnstable": "Unstable",
	"settings.updateChannelSwitchToUnstableTitle": "Switch to the unstable channel?",
	"settings.updateChannelSwitchToUnstableBody": "You will get main as it lands, built automatically every hour it changes. These builds are not tested releases and can break. You can switch back to stable at any time.",
	"settings.updateChannelSwitchToUnstableConfirm": "Use unstable",
	...
	"update.switchToUnstable": "Switch to unstable ({version})",
