const settings = {
	...
	"projectSettings.babysitterHandleCommentsReadOnlyDesc": "Without the reply capability, comments are still reviewed — suggested replies are drafted into a task note, never posted.",
	"projectSettings.babysitterAgent": "Babysitter Agent",
	"projectSettings.babysitterConfig": "Babysitter Config",
