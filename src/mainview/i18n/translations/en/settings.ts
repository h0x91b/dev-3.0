const settings = {
	...
	"projectSettings.saveToRepo": "Save to Repo",
	"projectSettings.savingToRepo": "Saving...",
	"projectSettings.exportToRepo": "Export to .dev3/config.json",
	"projectSettings.exporting": "Exporting...",
	"projectSettings.exportSuccess": "Settings exported to .dev3/config.json",
	"projectSettings.failedExport": "Failed to export settings: {error}",
	"projectSettings.failedSaveToRepo": "Failed to save to repo: {error}",
