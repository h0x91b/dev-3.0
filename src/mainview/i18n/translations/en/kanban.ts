const kanban = {
	...
	"task.showInSidebar": "Show in sidebar",
	"task.hiddenFailed": "Couldn’t update sidebar visibility — try again. ({error})",
	...
	"task.warnUnpushedButKept_one": "{count} unpushed commit, but another branch or tag still has it",
	"task.warnUnpushedButKept_other": "{count} unpushed commits, but another branch or tag still has them",
	"task.warnUnpushedButKeptUnknownCount": "This branch is on no remote, but another branch or tag still has its commits",
	...
	"launch.accountForLaunchHint": "Usage figures come from each account's own limits, refreshed when the agent last reported.",
	"launch.accountAddAnother": "Add another account",
	"launch.accountAddLeaving": "Nothing was launched. Add the account in Settings, then start the task again.",
	...
	"task.devStopAll": "Stop every dev server of this task",
	...
	"task.manualCompletionEnabledTooltip": "I’ll complete it myself — dev3 won’t suggest completing this task after a merge",
	"task.manualCompletionConsequence": "No prompt after a merge",
