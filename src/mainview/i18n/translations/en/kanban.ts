const kanban = {
	...
	"launch.accountActiveTitle": "Active account",
	"launch.accountGlobalSubtitle": "Global — applies to every agent dev3 launches, not per task.",
	"launch.accountSwitcherTooltip": "Active account for all new agent sessions (machine-wide). Click to switch.",
