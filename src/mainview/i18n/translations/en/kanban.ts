const kanban = {
	...
	"task.manualCompletion": "Manual completion",
	"task.manualCompletionEnabled": "Manual completion on",
	"task.manualCompletionTooltip": "Manual completion — merge detection only shows a notice",
	"task.manualCompletionEnabledTooltip": "Manual completion on — merge detection only shows a notice",
	"task.manualCompletionChangeFailed": "Could not change manual completion: {error}",
