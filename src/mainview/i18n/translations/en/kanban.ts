const kanban = {
	...
	"createTask.modeDescribe": "Describe",
	"createTask.modeImport": "Import",
	"createTask.importSessionLabel": "Session",
	"createTask.importPlaceholder": "Choose a session to import...",
	"createTask.importSearchPlaceholder": "Search sessions...",
	"createTask.importSearchLabel": "Search importable sessions",
	"createTask.importEmpty": "No sessions to import from this project yet.",
	"createTask.importLoading": "Looking for sessions...",
	"createTask.importTurns_one": "{count} turn",
	"createTask.importTurns_other": "{count} turns",
	"createTask.importUntitled": "Untitled session",
	"createTask.importReading": "Reading the conversation...",
	"createTask.importLoadFailed": "Could not look for sessions: {error}",
	"createTask.importDescribeFailed": "Could not read that session.",
	"createTask.importHint": "Agent sessions you ran in this project outside dev3. Importing one continues the conversation on a new branch.",
	...
	"createTask.descriptionImportPlaceholder": "Pick a session above and its conversation lands here...",
