const stats = {
	...
	// Time invested (per-task time tracking)
	"stats.time.title": "Time invested",
	"stats.time.subtitle": "Across tasks completed {period}",
	"stats.time.total": "Total time",
	"stats.time.agent": "Agent time",
	"stats.time.you": "Your time",
	"stats.time.totalCaption": "Create → complete",
	"stats.time.agentCaption": "Coding + AI review",
	"stats.time.youCaption": "Focused in the app",
	"stats.time.avgEach": "{value} avg / task",
	"stats.time.split": "Agent vs you",
	"stats.time.splitAgent": "Agent",
	"stats.time.splitYou": "You",
	"stats.time.trackingSince": "Agent / your split tracked since {date}",
	"stats.time.trackingNone": "Agent / your split starts tracking now",
	"stats.time.empty": "Complete a task to see time invested",
	"stats.time.perProjectTip": "{total} total · {agent} agent · {you} focused",
	// Empty / error states
