const common = {
	...
	"toast.agent.roleSender": "sent",
	"toast.agent.roleReceiver": "received",
	"toast.agent.openTask": "task #{seq} {title}",
	"toast.agent.openSenderNode": "open the sending task #{seq}: {preview}",
	"toast.agent.openReceiverNode": "open the receiving task #{seq}: {preview}",
	"toast.agent.sentCount": "wrote to {count}",
	"toast.agent.receivedCount": "answered by {count}",
	"toast.agent.mixedCount": "{out} sent · {in} received",
	"toast.agent.more": "+{count} more",
