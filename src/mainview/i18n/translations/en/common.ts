const common = {
	...
	"traffic.conversation.clipped_one": "{count} more character here — open the task for the whole text.",
	"traffic.conversation.clipped_other": "{count} more characters here — open the task for the whole text.",
