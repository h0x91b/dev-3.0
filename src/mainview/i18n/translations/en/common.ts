const common = {
	...
	"traffic.conversation.clipped_one": "Shortened here: {count} more character in the transcript.",
	"traffic.conversation.clipped_other": "Shortened here: {count} more characters in the transcript.",
