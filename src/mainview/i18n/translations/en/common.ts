const common = {
	...
	"imageViewer.commentMode": "Comment on a region",
	"imageViewer.commentModeHint": "Drag a rectangle over the image, or click a spot, to comment on it. Esc leaves comment mode.",
	"imageViewer.reviewEmpty": "No comments on this image yet.",
	...
	"imageViewer.titleMedia": "Shared media",
	"imageViewer.video": "Video",
	"imageViewer.copyVideoPath": "Copy video path",
	"imageViewer.downloadVideo": "Download video",
	"imageViewer.videoSaved": "Video saved to Downloads",
	"imageViewer.videoSaveFailed": "Couldn't save the video",
	"imageViewer.videoLoadError": "Video unavailable",
	"imageViewer.videoUnsupported": "This video can't play here: the engine doesn't support its format or codec. Open it in the default app instead.",
	"showVideo.toast_one": "Agent shared a video",
	"showVideo.toast_other": "Agent shared {count} videos",
	"showVideo.attention_one": "Shared a video",
	"showVideo.attention_other": "Shared {count} videos",
