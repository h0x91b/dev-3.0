const dashboard = {
	...
	"dashboard.firstRun.noAgentInstalled": "No agent CLI found on this machine. Install one — Claude Code, Codex, Gemini, Cursor Agent, OpenCode or GitHub Copilot — and dev-3.0 will pick it up.",
	...
	"header.devServers": "Dev servers",
	"header.devServerStart": "Start",
	"header.devServerStartAll": "Start all",
	"header.devServerStopAll": "Stop all",
	"header.devServerOpenPort": "Open port {port} in the browser",
