const tips = {
	...
	"tip.rightClickOpen.title": "Right-click a task",
	"tip.rightClickOpen.body": "Right-click any task card or sidebar row for labels, priority, rename, copies and Open in…",
	...
	"tip.agentTrafficLog.body": "Press ⇧⌘M and the last hour replays itself; widen the time window for older messages.",
