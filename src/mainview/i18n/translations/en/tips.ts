const tips = {
	...
	"tip.inlineDiffCollapseFiles.title": "Collapse the files panel",
	"tip.inlineDiffCollapseFiles.body": "Hide the diff files sidebar with the chevron in its header to give side-by-side diff more horizontal room — your choice is remembered.",
