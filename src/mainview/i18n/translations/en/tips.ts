const tips = {
	...
	"tip.projectQuickSwitch.title": "Jump to any project or task",
	"tip.projectQuickSwitch.body": "Press Cmd/Ctrl+K and type — it searches projects and your recently-visited tasks. Enter opens the best match.",
