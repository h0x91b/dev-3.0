const tips = {
	...
	"tip.autoFillBranch.title": "Choose the start branch",
	"tip.autoFillBranch.body": "If the repo is on a non-base branch, task creation asks whether to start from that branch or from the base branch.",
