const dashboard = {
	...
	"header.devServers": "Дев-серверы",
	"header.devServerStart": "Запустить",
	"header.devServerStartAll": "Запустить все",
	"header.devServerStopAll": "Остановить все",
	"header.devServerOpenPort": "Открыть порт {port} в браузере",
