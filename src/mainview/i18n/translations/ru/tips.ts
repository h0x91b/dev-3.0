const tips = {
	...
	"tip.retryTaskAttempts.title": "Добавить варианты",
	"tip.retryTaskAttempts.body": "Нажмите «+ Вариант» на активной карточке — запустится новая попытка с чистым worktree и тем же описанием.",
};
