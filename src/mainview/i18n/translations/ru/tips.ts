const tips = {
	...
	"tip.multiWindow.body": "File → New Window открывает ещё одно окно dev-3.0: по проекту на каждом мониторе, и любое окно можно закрыть, не выходя из приложения.",
	"tip.quitConfirm.title": "Закрытие последнего окна спросит подтверждение",
	"tip.quitConfirm.body": "Выход — через Cmd+Q, меню или закрытие последнего окна — теперь показывает подтверждение, чтобы фоновые tmux-сессии не исчезли внезапно.",
};
