const tips = {
	...
	"tip.reviewDiscardGuard.body": "Если случайно нажать Esc или Назад с непустыми комментариями ревью к диффу, dev-3.0 спросит подтверждение — случайный выход больше не сотрёт незавершённое ревью.",
};
