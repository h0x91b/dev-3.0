const tips = {
	...
	"tip.projectQuickSwitch.title": "Переход к любому проекту или задаче",
	"tip.projectQuickSwitch.body": "Нажми Cmd/Ctrl+K и начни вводить — поиск идёт по проектам и недавно открытым задачам. Enter открывает лучшее совпадение.",
