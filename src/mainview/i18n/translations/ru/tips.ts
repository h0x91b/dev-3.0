const tips = {
	...
	"tip.hibernateQuit.title": "Гибернация перед перезагрузкой",
	"tip.hibernateQuit.body": "Нажмите Cmd+Q и выберите «Гибернация и выход» — агенты возобновят работу автоматически при следующем запуске.",
};
