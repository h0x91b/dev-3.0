const tips = {
	...
	"tip.helpMode.body": "Нажмите ⇧⌘/ (или Help → Explain This Screen) — каждая зона получит значок (i); кликните, чтобы узнать, что она делает.",
	"tip.helpSpots.title": "Маленькие (i) знают всё",
	"tip.helpSpots.body": "В заголовках секций есть маленькая (i) — наведите или кликните, чтобы узнать, что это за секция и как ей пользоваться.",
};
