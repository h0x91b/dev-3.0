const tips = {
	...
	"tip.taskHintNav.title": "Переход к задачам по F",
	"tip.taskHintNav.body": "На доске нажмите F — на каждой задаче появится метка; наберите её буквы, чтобы сразу перейти.",
};
