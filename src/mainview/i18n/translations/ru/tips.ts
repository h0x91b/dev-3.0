const tips = {
	...
	"tip.tmuxIconAnimations.title": "Иконки показывают, а не рассказывают",
	"tip.tmuxIconAnimations.body": "Наведите на любую иконку tmux-тулбара — она анимацией показывает свою операцию: от сплита панели до зума.",
};
