const tips = {
	...
	"tip.doubleClickTodo.body": "Дважды кликните по пустому месту в любой колонке доски, чтобы сразу открыть форму новой задачи.",
	"tip.rightClickOpen.title": "Правый клик по задаче",
	"tip.rightClickOpen.body": "Правый клик по карточке или строке в сайдбаре: лейблы, приоритет, переименование, копирование и Open in…",
	...
	"tip.agentTrafficLog.body": "Нажми ⇧⌘M — последний час проиграется сам; расширь период, чтобы увидеть более ранние сообщения.",
	"tip.continueInAnotherAgent.title": "Сменить агента по ходу",
	"tip.continueInAnotherAgent.body": "В «+ Агент» отметь «Продолжить разговор этой задачи» — новый агент получит пересказ сессии и подхватит работу.",
