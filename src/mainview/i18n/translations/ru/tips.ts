const tips = {
	...
	"tip.projectQuickSwitch.body": "Нажми Cmd/Ctrl+T, начни вводить название проекта и нажми Enter, чтобы перейти к лучшему совпадению — номер запоминать не нужно.",
