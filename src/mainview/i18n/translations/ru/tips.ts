const tips = {
	...
	"tip.showDiffButton.body": "Нажмите «Показать diff» в панели задачи, чтобы заменить терминал inline diff’ом ветки, а потом нажмите Esc, чтобы вернуться.",
	"tip.diffDefaultLayout.title": "Выберите diff layout",
	"tip.diffDefaultLayout.body": "Откройте Глобальные настройки и выберите, должен ли «Показать diff» стартовать в side-by-side или Unified режиме.",
	...
	"tip.inlineDiffComments.body": "В «Показать diff» нажмите + рядом со строкой, чтобы оставить inline comment ровно в нужном месте.",
	...
	"tip.diffCompareDefault.body": "В Project Settings можно выбрать, сравнивать ли статус ветки и «Показать diff» с origin/<base> или с локальной базовой веткой.",
