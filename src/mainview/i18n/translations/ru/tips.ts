const tips = {
	...
	"tip.compactEmptyColumns.body": "Когда окно меньше ~1400px, пустые Kanban-колонки схлопываются до ширины своего заголовка. Наведи и подержи курсор — колонка плавно раскроется обратно. Во время перетаскивания таски колонка остаётся узкой, чтобы доска не дёргалась.",
};
