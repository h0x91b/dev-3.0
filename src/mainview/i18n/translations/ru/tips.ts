const tips = {
	...
	"tip.autoFillBranch.title": "Выберите стартовую ветку",
	"tip.autoFillBranch.body": "Если репозиторий стоит не на базовой ветке, при создании задачи приложение спросит, стартовать с неё или с base branch.",
