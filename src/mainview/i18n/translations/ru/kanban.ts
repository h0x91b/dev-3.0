const kanban = {
	...
	"createTask.modeDescribe": "Описать",
	"createTask.modeImport": "Импорт",
	"createTask.importSessionLabel": "Сессия",
	"createTask.importPlaceholder": "Выберите сессию для импорта...",
	"createTask.importSearchPlaceholder": "Поиск сессий...",
	"createTask.importSearchLabel": "Поиск доступных сессий",
	"createTask.importEmpty": "В этом проекте пока нет сессий для импорта.",
	"createTask.importLoading": "Ищем сессии...",
	"createTask.importTurns_one": "{count} ход",
	"createTask.importTurns_few": "{count} хода",
	"createTask.importTurns_many": "{count} ходов",
	"createTask.importTurns_other": "{count} ходов",
	"createTask.importUntitled": "Сессия без названия",
	"createTask.importReading": "Читаем диалог...",
	"createTask.importLoadFailed": "Не удалось найти сессии: {error}",
	"createTask.importDescribeFailed": "Не удалось прочитать эту сессию.",
	"createTask.importHint": "Сессии агента, запущенные в этом проекте вне dev3. Импорт продолжит диалог в новой ветке.",
	...
	"createTask.descriptionImportPlaceholder": "Выберите сессию выше — её диалог появится здесь...",
