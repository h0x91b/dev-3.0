const kanban = {
	...
	"launch.accountActiveTitle": "Активный аккаунт",
	"launch.accountGlobalSubtitle": "Глобально — применяется ко всем агентам, которые запускает dev3, а не к отдельной задаче.",
	"launch.accountSwitcherTooltip": "Активный аккаунт для всех новых сессий агентов (на всей машине). Нажмите, чтобы сменить.",
