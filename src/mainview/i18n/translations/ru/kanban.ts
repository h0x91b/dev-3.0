const kanban = {
	...
	"task.detailGone": "Этой задачи больше нет на доске.",
	...
	"task.hiddenFromSidebar": "Скрыта из боковой панели",
	"task.hideFromSidebar": "Скрыть из боковой панели",
	"task.showInSidebar": "Показать в боковой панели",
	"task.hiddenFailed": "Не удалось изменить видимость в боковой панели: {error}",
	...
	"task.warnUnpushedButKept_one": "{count} незапушенный коммит, но он остаётся в другой ветке или теге",
	"task.warnUnpushedButKept_few": "{count} незапушенных коммита, но они остаются в другой ветке или теге",
	"task.warnUnpushedButKept_many": "{count} незапушенных коммитов, но они остаются в другой ветке или теге",
	"task.warnUnpushedButKept_other": "{count} незапушенных коммитов, но они остаются в другой ветке или теге",
	"task.warnUnpushedButKeptUnknownCount": "Ветки нет ни на одном remote, но её коммиты остаются в другой ветке или теге",
	...
	"launch.accountForLaunchHint": "Расход взят из лимитов самих аккаунтов, по последним данным от агента.",
	"launch.accountAddAnother": "Добавить ещё аккаунт",
	"launch.accountAddLeaving": "Задача не запущена. Добавьте аккаунт в настройках и запустите её снова.",
	...
	"spawnAgent.handoff": "Продолжить разговор этой задачи",
	"spawnAgent.handoffDesc_one": "Новый агент получит пересказ сессии {agent} ({count} реплика): ваши запросы и его ответы дословно, действия — кратко. Агенты не умеют подхватывать сессии друг друга, поэтому переключение — это пересказ.",
	"spawnAgent.handoffDesc_few": "Новый агент получит пересказ сессии {agent} ({count} реплики): ваши запросы и его ответы дословно, действия — кратко. Агенты не умеют подхватывать сессии друг друга, поэтому переключение — это пересказ.",
	"spawnAgent.handoffDesc_many": "Новый агент получит пересказ сессии {agent} ({count} реплик): ваши запросы и его ответы дословно, действия — кратко. Агенты не умеют подхватывать сессии друг друга, поэтому переключение — это пересказ.",
	"spawnAgent.handoffDesc_other": "Новый агент получит пересказ сессии {agent} ({count} реплик): ваши запросы и его ответы дословно, действия — кратко. Агенты не умеют подхватывать сессии друг друга, поэтому переключение — это пересказ.",
	"spawnAgent.handoffSent": "Разговор передан — чтение пересказа станет первым ходом нового агента.",
	"spawnAgent.handoffNotDelivered": "Агент запустился, но указатель на пересказ до него не дошёл. Пересказ лежит в {path} — покажите его агенту вручную.",
	...
	"task.manualCompletionEnabledTooltip": "Завершу самостоятельно — dev3 не предложит завершить задачу после merge",
	"task.manualCompletionConsequence": "После merge не спросит",
