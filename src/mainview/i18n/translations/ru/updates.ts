const updates = {
	...
	"updateSim.totalEntries_one": "всего записей: {count}",
	"updateSim.totalEntries_few": "всего записей: {count}",
	"updateSim.totalEntries_many": "всего записей: {count}",
	"updateSim.totalEntries_other": "всего записей: {count}",
	...
	"updateSim.mergedPRs_one": "смёржено PR с тега: {count}",
	"updateSim.mergedPRs_few": "смёржено PR с тега: {count}",
	"updateSim.mergedPRs_many": "смёржено PR с тега: {count}",
	"updateSim.mergedPRs_other": "смёржено PR с тега: {count}",
