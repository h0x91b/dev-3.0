const settings = {
	...
	"projectSettings.babysitterHandleCommentsReadOnlyDesc": "Без права отвечать комментарии всё равно разбираются — черновики ответов складываются в заметку задачи и никогда не публикуются.",
	"projectSettings.babysitterAgent": "Агент-няня",
	"projectSettings.babysitterConfig": "Конфигурация няни",
