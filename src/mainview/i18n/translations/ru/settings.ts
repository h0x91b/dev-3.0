const settings = {
	...
	"settings.updateChannelDesc": "Стабильный отдаёт только помеченные релизы. Нестабильный собирается из каждой партии мержей в main — это не протестированный релиз.",
	"settings.updateChannelStable": "Стабильный",
	"settings.updateChannelUnstable": "Нестабильный",
	"settings.updateChannelSwitchToUnstableTitle": "Перейти на нестабильный канал?",
	"settings.updateChannelSwitchToUnstableBody": "Вы будете получать main как он есть — сборка запускается каждый час, если ветка изменилась. Это не протестированные релизы, они могут ломаться. Вернуться на стабильный можно в любой момент.",
	"settings.updateChannelSwitchToUnstableConfirm": "Использовать нестабильный",
	...
	"update.switchToUnstable": "Перейти на нестабильный ({version})",
