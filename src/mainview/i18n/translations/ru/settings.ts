const settings = {
	...
	"settings.preventSleepDesc": "Не позволяет Mac засыпать, пока работают агенты (использует caffeinate)",
	"settings.preventSleepNotAvailable": "caffeinate не найден в PATH. Обычно поставляется с macOS — проверьте систему.",
