const settings = {
	...
	"settings.diffTool": "Инструмент для diff",
	"settings.diffToolDesc": "Инструмент для просмотра изменений в задачах",
	"settings.diffToolNotFound": "не найден",
	"settings.diffToolCustomHint": "Используйте $LOCAL для базовой версии и $REMOTE для изменённой. Пример: my-diff-tool --left $LOCAL --right $REMOTE",
