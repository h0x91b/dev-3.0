const settings = {
	...
	"projectSettings.saveToRepo": "Сохранить в репо",
	"projectSettings.savingToRepo": "Сохранение...",
	"projectSettings.exportToRepo": "Экспорт в .dev3/config.json",
	"projectSettings.exporting": "Экспорт...",
	"projectSettings.exportSuccess": "Настройки экспортированы в .dev3/config.json",
	"projectSettings.failedExport": "Ошибка экспорта: {error}",
	"projectSettings.failedSaveToRepo": "Не удалось сохранить в репо: {error}",
