const settings = {
	...
	"settings.tunnel": "Cloudflare Tunnel",
	"settings.tunnelDesc": "Открывает публичный туннель Cloudflare вместо локального IP. Требуется установленный cloudflared.",
	"settings.tunnelHint": "Установка: brew install cloudflared. При включении QR-код использует публичный https URL, доступный из любой сети. Требуется перезапуск.",
