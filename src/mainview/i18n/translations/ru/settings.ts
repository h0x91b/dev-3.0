const settings = {
	...
	"projectSettings.tabWorktreeDesc": "Переопределения для worktree — коммитятся в git или только локальные",
	"projectSettings.appConfigWarning": "Хранится локально на этой машине. Не передаётся команде.",
	"projectSettings.worktreeSelector": "Выберите задачу для редактирования конфига worktree",
	"projectSettings.noActiveWorktrees": "Нет активных worktree — сначала запустите задачу",
