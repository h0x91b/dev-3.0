const common = {
	...
	"goTo.title": "Перейти к проекту или задаче",
	"goTo.placeholderProjects": "Поиск проектов…",
	"goTo.placeholderMixed": "Поиск проектов и задач…",
	"goTo.placeholderTasks": "Поиск задач…",
	"goTo.noProjects": "Нет подходящих проектов",
	"goTo.noMixed": "Нет подходящих проектов или задач",
	"goTo.noTasks": "Нет подходящих задач",
	"goTo.hint": "⇧ режим · ↑↓ выбор · ⏎ открыть · esc",
	"goTo.modeGroupLabel": "Режим поиска",
	"goTo.modeProjects": "Проекты",
	"goTo.modeMixed": "Вместе",
	"goTo.modeTasks": "Задачи",
	...
	"command.goTo": "Перейти к проекту или задаче",
