const common = {
	...
	"toast.agent.roleSender": "написал",
	"toast.agent.roleReceiver": "получил",
	"toast.agent.openTask": "таск #{seq} {title}",
	"toast.agent.openSenderNode": "открыть отправителя #{seq}: {preview}",
	"toast.agent.openReceiverNode": "открыть получателя #{seq}: {preview}",
	"toast.agent.sentCount": "разослал {count}",
	"toast.agent.receivedCount": "получил {count}",
	"toast.agent.mixedCount": "{out} ушло · {in} пришло",
	"toast.agent.more": "+{count} ещё",
