const common = {
	...
	"imageViewer.commentMode": "Комментировать область",
	"imageViewer.commentModeHint": "Выделите прямоугольник на изображении или кликните точку, чтобы оставить комментарий. Esc выходит из режима.",
	"imageViewer.reviewEmpty": "К этому изображению пока нет комментариев.",
	...
	"imageViewer.titleMedia": "Переданные медиа",
	"imageViewer.video": "Видео",
	"imageViewer.copyVideoPath": "Скопировать путь к видео",
	"imageViewer.downloadVideo": "Скачать видео",
	"imageViewer.videoSaved": "Видео сохранено в Загрузки",
	"imageViewer.videoSaveFailed": "Не удалось сохранить видео",
	"imageViewer.videoLoadError": "Видео недоступно",
	"imageViewer.videoUnsupported": "Это видео здесь не воспроизводится: движок не поддерживает его формат или кодек. Откройте его в приложении по умолчанию.",
	"showVideo.toast_one": "Агент прислал видео",
	"showVideo.toast_few": "Агент прислал {count} видео",
	"showVideo.toast_many": "Агент прислал {count} видео",
	"showVideo.toast_other": "Агент прислал {count} видео",
	"showVideo.attention_one": "Прислал видео",
	"showVideo.attention_few": "Прислал {count} видео",
	"showVideo.attention_many": "Прислал {count} видео",
	"showVideo.attention_other": "Прислал {count} видео",
	...
	"artifactViewer.fileSaved": "Файл сохранён в Downloads",
	"artifactViewer.fileSaveFailed": "Не удалось сохранить файл",
