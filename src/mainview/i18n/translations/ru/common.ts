const common = {
	...
	"app.branchMergedManualCompletion": "Ручное завершение",
	"app.manualCompletionAgentEnabled": "Агент включил ручное завершение для этой задачи.",
	"app.manualCompletionAgentDisabled": "Агент снова включил предложения о завершении после merge.",
	"app.manualCompletionChangeFailed": "Не удалось изменить ручное завершение: {error}",
