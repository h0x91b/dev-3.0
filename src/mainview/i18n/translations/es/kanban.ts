const kanban = {
	...
	"task.showInSidebar": "Mostrar en la barra lateral",
	"task.hiddenFailed": "No se pudo cambiar la visibilidad en la barra lateral: {error}",
	...
	"task.warnNeverPushedUnknownCount": "Esta rama no está en ningún remoto y sus commits no se pueden contar — se perderán",
	"task.warnUnpushed_one": "{count} commit sin enviar — se perderá",
	"task.warnUnpushed_other": "{count} commits sin enviar — se perderán",
	"task.warnUnpushedButKept_one": "{count} commit sin enviar, pero otra rama o etiqueta todavía lo tiene",
	"task.warnUnpushedButKept_other": "{count} commits sin enviar, pero otra rama o etiqueta todavía los tienen",
	"task.warnUnpushedButKeptUnknownCount": "Esta rama no está en ningún remoto, pero otra rama o etiqueta todavía tiene sus commits",
	...
	"launch.accountForLaunchHint": "El uso proviene de los límites de cada cuenta, según el último informe del agente.",
	"launch.accountAddAnother": "Añadir otra cuenta",
	"launch.accountAddLeaving": "No se lanzó nada. Añade la cuenta en Ajustes y vuelve a iniciar la tarea.",
	...
	"scheduleMessage.discardConfirm": "¿Descartar este mensaje sin enviar?",
	"scheduleMessage.keepEditing": "Seguir editando",
	"scheduleMessage.discard": "Descartar mensaje",
	...
	"spawnAgent.handoffSent": "La conversación se entregó — leer el resumen es el primer turno del nuevo agente.",
	...
	"task.devStopAll": "Detener todos los servidores de desarrollo de esta tarea",
	...
	"task.manualCompletionEnabledTooltip": "La completaré por mi cuenta — dev3 no sugerirá completarla tras una fusión",
	"task.manualCompletionConsequence": "Sin aviso tras la fusión",
