const kanban = {
	...
	"createTask.modeDescribe": "Describir",
	"createTask.modeImport": "Importar",
	"createTask.importSessionLabel": "Sesión",
	"createTask.importPlaceholder": "Elige una sesión para importar...",
	"createTask.importSearchPlaceholder": "Buscar sesiones...",
	"createTask.importSearchLabel": "Buscar sesiones importables",
	"createTask.importEmpty": "Todavía no hay sesiones que importar en este proyecto.",
	"createTask.importLoading": "Buscando sesiones...",
	"createTask.importTurns_one": "{count} turno",
	"createTask.importTurns_other": "{count} turnos",
	"createTask.importUntitled": "Sesión sin título",
	"createTask.importReading": "Leyendo la conversación...",
	"createTask.importLoadFailed": "No se pudieron buscar sesiones: {error}",
	"createTask.importDescribeFailed": "No se pudo leer esa sesión.",
	"createTask.importHint": "Sesiones de agente que ejecutaste en este proyecto fuera de dev3. Importar una continúa la conversación en una rama nueva.",
	...
	"createTask.descriptionImportPlaceholder": "Elige una sesión arriba y su conversación aparecerá aquí...",
