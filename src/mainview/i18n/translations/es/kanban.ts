const kanban = {
	...
	"task.manualCompletion": "Finalización manual",
	"task.manualCompletionEnabled": "Finalización manual activada",
	"task.manualCompletionTooltip": "Finalización manual — el merge solo muestra un aviso",
	"task.manualCompletionEnabledTooltip": "Finalización manual activada — el merge solo muestra un aviso",
	"task.manualCompletionChangeFailed": "No se pudo cambiar la finalización manual: {error}",
