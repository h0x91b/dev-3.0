const kanban = {
	...
	"launch.accountActiveTitle": "Cuenta activa",
	"launch.accountGlobalSubtitle": "Global — se aplica a todos los agentes que lanza dev3, no por tarea.",
	"launch.accountSwitcherTooltip": "Cuenta activa para todas las nuevas sesiones de agentes (en todo el equipo). Haz clic para cambiar.",
