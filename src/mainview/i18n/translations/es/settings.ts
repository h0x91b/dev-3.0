const settings = {
	...
	"settings.accountsApiHintCodex": "Acceso directo por API en lugar de un inicio de sesión de ChatGPT: cualquier endpoint compatible con OpenAI (Baseten, OpenRouter, un servidor vLLM local, …). dev3 pasa el proveedor a codex por línea de comandos, así que tu ~/.codex/config.toml nunca se toca.",
	"settings.accountsApiBaseUrlRequired": "Base URL",
	"settings.accountsApiBaseUrlHintCodex": "Obligatorio. El endpoint compatible con OpenAI con el que habla codex, ej.: https://inference.baseten.co/v1. Se entrega como -c model_providers.dev3.base_url. Codex solo habla la Responses API.",
	"settings.accountsApiKeyHintDetailCodex": "Tu clave del proveedor. Se guarda localmente con permisos 0600 y se inyecta en las nuevas sesiones como DEV3_CODEX_API_KEY, que el bloque del proveedor lee mediante env_key — la clave nunca llega a la línea de comandos. Pulsa el ojo para revelarla.",
	"settings.accountsApiModel": "Modelo",
	"settings.accountsApiModelHintCodex": "El id de modelo que sirve este endpoint, ej.: deepseek-ai/DeepSeek-V4. Sustituye al --model del preset en cada lanzamiento de este perfil. Déjalo vacío para conservar el modelo del preset.",
	"settings.accountsApiEnvHintCodex": "Líneas KEY=value adicionales inyectadas en la sesión, una por línea. Ej.: HTTPS_PROXY para un proxy corporativo, o variables personalizadas del gateway.",
