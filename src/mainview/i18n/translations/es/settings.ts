const settings = {
	...
	"settings.tunnelDesc": "Enruta el acceso remoto a través de un túnel público de Cloudflare en lugar de la IP local. Requiere cloudflared instalado.",
	"settings.tunnelHint": "Instalar: brew install cloudflared. Cuando está habilitado, el código QR usa una URL pública https accesible desde cualquier lugar. Requiere reinicio.",
