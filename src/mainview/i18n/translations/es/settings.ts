const settings = {
	...
	"projectSettings.saveToRepo": "Guardar en repo",
	"projectSettings.savingToRepo": "Guardando...",
	"projectSettings.exportToRepo": "Exportar a .dev3/config.json",
	"projectSettings.exporting": "Exportando...",
	"projectSettings.exportSuccess": "Configuración exportada a .dev3/config.json",
	"projectSettings.failedExport": "Error al exportar: {error}",
	"projectSettings.failedSaveToRepo": "Error al guardar en repo: {error}",
	"projectSettings.sourceRepo": "repo",
	"projectSettings.sourceLocal": "local",
	"projectSettings.sourceGlobal": "global",
