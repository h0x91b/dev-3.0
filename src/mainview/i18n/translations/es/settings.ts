const settings = {
	...
	"projectSettings.babysitterHandleCommentsReadOnlyDesc": "Sin la capacidad de responder, los comentarios se siguen revisando — las respuestas sugeridas se redactan en una nota de la tarea, nunca se publican.",
	"projectSettings.babysitterAgent": "Agente niñera",
	"projectSettings.babysitterConfig": "Configuración de la niñera",
