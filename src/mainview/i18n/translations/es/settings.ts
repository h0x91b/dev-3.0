const settings = {
	...
	"projectSettings.tabProjectDesc": "Configuración del proyecto — almacenada localmente en esta máquina, no compartida con el equipo",
	"projectSettings.tabWorktreeDesc": "Sobrecargas por worktree — tienen prioridad sobre Config del proyecto cuando están definidas",
	...
	"projectSettings.worktreeRepoDesc": "Se commitea en git como .dev3/config.json — compartido con tu equipo. Sobreescribe Config del proyecto para este worktree.",
	"projectSettings.worktreeLocalDesc": "Sobrecargas específicas de la máquina — ignoradas por git (.dev3/config.local.json). Prioridad más alta, nunca compartidas.",
	"projectSettings.worktreePriorityHint": "La config del worktree tiene prioridad sobre Config del proyecto. Si un campo está definido aquí, el valor de Config del proyecto se ignora para esta tarea.",
