const settings = {
	...
	"settings.updateChannelDesc": "Estable entrega solo lanzamientos etiquetados. Inestable se compila con cada lote de fusiones en main: no es un lanzamiento probado.",
	"settings.updateChannelStable": "Estable",
	"settings.updateChannelUnstable": "Inestable",
	"settings.updateChannelSwitchToUnstableTitle": "¿Cambiar al canal inestable?",
	"settings.updateChannelSwitchToUnstableBody": "Recibirás main tal como se fusiona, compilado automáticamente cada hora en que cambie. Estas compilaciones no son lanzamientos probados y pueden fallar. Puedes volver a estable cuando quieras.",
	"settings.updateChannelSwitchToUnstableConfirm": "Usar inestable",
	...
	"update.switchToUnstable": "Cambiar a inestable ({version})",
