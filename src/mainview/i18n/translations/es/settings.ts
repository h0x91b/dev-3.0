const settings = {
	...
	"settings.accountsActive": "Activa",
	...
	"settings.accountsNewSessionsHint": "El cambio afecta solo a las sesiones nuevas — las sesiones en ejecución mantienen su login actual.",
