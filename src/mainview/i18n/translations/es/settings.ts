const settings = {
	...
	"settings.preventSleepDesc": "Mantiene tu Mac despierto mientras los agentes están activos (usa caffeinate)",
	"settings.preventSleepNotAvailable": "caffeinate no encontrado en PATH. Viene incluido con macOS por defecto — revisa tu sistema.",
