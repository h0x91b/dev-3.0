const settings = {
	...
	"settings.diffTool": "Herramienta de Diff",
	"settings.diffToolDesc": "Herramienta para ver diferencias en las tareas",
	"settings.diffToolNotFound": "no encontrado",
	"settings.diffToolCustomHint": "Usa $LOCAL para la versión base y $REMOTE para la versión modificada. Ejemplo: my-diff-tool --left $LOCAL --right $REMOTE",
