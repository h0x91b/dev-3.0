const settings = {
	...
	"projectSettings.tabWorktreeDesc": "Sobrecargas por worktree — commiteadas en git o solo locales",
	"projectSettings.appConfigWarning": "Almacenado localmente en esta máquina. No se comparte con el equipo.",
	"projectSettings.worktreeSelector": "Selecciona una tarea para editar la config de su worktree",
	"projectSettings.noActiveWorktrees": "No hay worktrees activos — inicia una tarea primero",
