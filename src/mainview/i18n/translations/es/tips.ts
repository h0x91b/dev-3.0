const tips = {
	...
	"tip.taskHintNav.title": "Salta a tareas con F",
	"tip.taskHintNav.body": "En el tablero, pulsa F para etiquetar cada tarea y escribe sus letras para saltar directamente allí.",
};
