const tips = {
	...
	"tip.rightClickOpen.title": "Clic derecho en una tarea",
	"tip.rightClickOpen.body": "Haz clic derecho en una tarjeta o fila de la barra lateral: etiquetas, prioridad, renombrar, copiar y Open in…",
	...
	"tip.filterTokens.body": "En la búsqueda escribe label:Bug agent:Codex status:review is:attention is:hidden has:port — o usa el embudo para construirlo.",
	...
	"tip.agentTrafficLog.body": "Pulsa ⇧⌘M y la última hora se reproduce sola; amplía el periodo para ver mensajes anteriores.",
