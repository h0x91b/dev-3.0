const tips = {
	...
	"tip.autoFillBranch.title": "Elige la rama inicial",
	"tip.autoFillBranch.body": "Si el repo está en una rama no base, al crear la tarea podrás elegir entre esa rama y la rama base.",
