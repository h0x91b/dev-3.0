const tips = {
	...
	"tip.projectQuickSwitch.title": "Ir a cualquier proyecto o tarea",
	"tip.projectQuickSwitch.body": "Pulsa Cmd/Ctrl+K y escribe — busca en proyectos y en tus tareas visitadas recientemente. Enter abre la mejor coincidencia.",
