const tips = {
	...
	"tip.compactEmptyColumns.title": "Las columnas vacías se encogen en pantallas estrechas",
	"tip.compactEmptyColumns.body": "Cuando tu ventana mide menos de ~1400px, las columnas vacías del Kanban se reducen al ancho de su título. Pasa el ratón un instante y se expanden de nuevo; durante un arrastre permanecen compactas para que el tablero no se mueva bajo el cursor.",
};
