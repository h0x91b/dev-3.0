const help = {
	...
	"help.diff.review.body":
		"Arrastra por el margen de líneas para comentar un rango. Copy pone toda la revisión en el portapapeles como un prompt; Send la escribe directamente en el agente — el que enfocaste por última vez si hay varios, si no el panel activo. «Enviar ya» en el compositor manda un comentario al instante y no lo guarda en la revisión. La revisión sobrevive reinicios durante 3 días.",
