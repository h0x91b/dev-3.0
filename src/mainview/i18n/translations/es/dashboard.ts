const dashboard = {
	...
	"dashboard.firstRun.noAgentInstalled": "No se encontró ninguna CLI de agente en esta máquina. Instala una — Claude Code, Codex, Gemini, Cursor Agent, OpenCode o GitHub Copilot — y dev-3.0 la detectará.",
	...
	"header.devServers": "Servidores de desarrollo",
	"header.devServerStart": "Iniciar",
	"header.devServerStartAll": "Iniciar todos",
	"header.devServerStopAll": "Detener todos",
	"header.devServerOpenPort": "Abrir el puerto {port} en el navegador",
