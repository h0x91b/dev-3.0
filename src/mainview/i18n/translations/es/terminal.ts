const terminal = {
	...
	"bugHunters.explainer": "Cada cazador se abre en la mitad derecha de esta sesión y ejecuta /dev3-bug-hunter con una estrategia de exploración semilla. Solo lectura — sin commits ni ediciones.",
