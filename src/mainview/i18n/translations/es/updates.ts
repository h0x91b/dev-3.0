const updates = {
	...
	"updateSim.totalEntries_one": "{count} entrada en total",
	"updateSim.totalEntries_other": "{count} entradas en total",
	...
	"updateSim.mergedPRs_one": "{count} PR fusionado desde el tag",
	"updateSim.mergedPRs_other": "{count} PRs fusionados desde el tag",
