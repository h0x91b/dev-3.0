const common = {
	...
	"traffic.conversation.clipped_one": "Acortado aquí: {count} carácter más en la transcripción.",
	"traffic.conversation.clipped_other": "Acortado aquí: {count} caracteres más en la transcripción.",
