const common = {
	...
	"traffic.conversation.clipped_one": "{count} carácter más aquí: abre la tarea para ver el texto completo.",
	"traffic.conversation.clipped_other": "{count} caracteres más aquí: abre la tarea para ver el texto completo.",
