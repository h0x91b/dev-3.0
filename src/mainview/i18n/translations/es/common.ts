const common = {
	...
	"toast.agent.roleSender": "envió",
	"toast.agent.roleReceiver": "recibió",
	"toast.agent.openTask": "tarea #{seq} {title}",
	"toast.agent.openSenderNode": "abrir la tarea que envió #{seq}: {preview}",
	"toast.agent.openReceiverNode": "abrir la tarea que recibió #{seq}: {preview}",
	"toast.agent.sentCount": "escribió a {count}",
	"toast.agent.receivedCount": "le respondieron {count}",
	"toast.agent.mixedCount": "{out} enviados · {in} recibidos",
	"toast.agent.more": "+{count} más",
