const common = {
	...
	"imageViewer.commentMode": "Comentar una región",
	"imageViewer.commentModeHint": "Arrastra un rectángulo sobre la imagen, o haz clic en un punto, para comentarlo. Esc sale del modo.",
	"imageViewer.reviewEmpty": "Esta imagen aún no tiene comentarios.",
	...
	"imageViewer.titleMedia": "Multimedia compartida",
	"imageViewer.video": "Vídeo",
	"imageViewer.copyVideoPath": "Copiar la ruta del vídeo",
	"imageViewer.downloadVideo": "Descargar vídeo",
	"imageViewer.videoSaved": "Vídeo guardado en Descargas",
	"imageViewer.videoSaveFailed": "No se pudo guardar el vídeo",
	"imageViewer.videoLoadError": "Vídeo no disponible",
	"imageViewer.videoUnsupported": "Este vídeo no se puede reproducir aquí: el motor no admite su formato o códec. Ábrelo en la aplicación predeterminada.",
	"showVideo.toast_one": "El agente compartió un vídeo",
	"showVideo.toast_other": "El agente compartió {count} vídeos",
	"showVideo.attention_one": "Compartió un vídeo",
	"showVideo.attention_other": "Compartió {count} vídeos",
