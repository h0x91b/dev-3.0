	...
	return (
		<>
			<button
				...
				aria-expanded={open}
				className={`relative inline-flex items-center justify-center w-4 h-4 rounded text-fg-3 hover:text-accent focus-visible:text-accent transition-colors text-[0.75rem] leading-none flex-shrink-0 after:absolute after:left-1/2 after:top-1/2 after:h-6 after:w-6 after:-translate-x-1/2 after:-translate-y-1/2 after:content-[''] ${className ?? ""}`}
