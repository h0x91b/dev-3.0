				...
				return (
					<Tooltip key={variant.id} content={variantLabel} detail={title}>
						<button
							...
							className={`inline-flex h-7 min-w-[2.25rem] items-center justify-center gap-1 rounded-md px-1.5 text-dense font-semibold tabular-nums transition-colors focus-visible:ring-1 focus-visible:ring-accent ${
								isCurrent
